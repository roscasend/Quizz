...
public final class QuizEvaluator {
    public QuizResult evaluate(Quizz quizz, Map<String, Set<String>> responsesByQuestionId) {
        ...
        for (QuestionEvaluationView question : quizz.getEvaluationQuestions()) {
        ...
        return new QuizResult(correct, quizz.getEvaluationQuestions().size(), reviews);
    }
}
